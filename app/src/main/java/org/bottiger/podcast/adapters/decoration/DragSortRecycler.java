...
public class DragSortRecycler extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener, PlaylistScrollListener.PostScrollListener {
    ...
    private int mNavigationBarHeight = 70; // default dummy guess
    ...
    public void onTouchEvent(RecyclerView rv, MotionEvent e) {
        ...
        float h = (rv.getHeight() * (1-autoScrollWindow))-2*mNavigationBarHeight;
        if (fingerY > h)
        {
            //scrollAmount = (fingerY - (rv.getHeight() * (1-autoScrollWindow)));
            scrollAmount = (fingerY - h);
        }
    ...
    public void setNavigationHeight(int argHeight) {
        mNavigationBarHeight = argHeight;
    }
}
