 ...
 */
@TargetApi(16)
public final class NewExoPlayer implements ExoPlayer {
    ...
    /**
     * A listener for video rendering information from a {@link NewExoPlayer}.
     */
    ...
    public static NewExoPlayer newInstance(@NonNull Context argContext) {
        ...
        NewExoPlayer player = new NewExoPlayer(argContext, trackSelector, loadControl, drmSessionManager,
    ...
    private void buildRenderers(Context context, DrmSessionManager drmSessionManager,
        ...
        Renderer audioRenderer = new PodcastMediaCodecAudioRenderer(MediaCodecSelector.DEFAULT,
