...
/**
 * Created by Arvid on 8/29/2015.
 */
@TargetApi(16)
public class SoundApi {
    private SparseArray<Track> mTracks = new SparseArray<>();
    ...
    public SoundApi(@NonNull Context argContext) {
    ...
    private final IPlayMedia_0_8.Stub mBinder = new IPlayMedia_0_8.Stub() {
        ...
        public long startSession(IDeathCallback_0_8 cb) {
            ...
            synchronized (this) {
                mTracks.append(sessionId, new Track(mContext, cb));
            }
            return sessionId;
        }
