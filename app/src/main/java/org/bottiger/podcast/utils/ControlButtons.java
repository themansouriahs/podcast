...
public class ControlButtons {
	...
	public static PlaylistFragment fragment = null;
	...
	public static void setPlayerListeners(View listView, View playerView,
		...
		viewHolder.downloadButton = (DownloadButtonView) playerView
				.findViewById(R.id.download);
		viewHolder.queueButton = (PlayerButtonView) playerView
				.findViewById(R.id.queue);
		viewHolder.seekbar = (SeekBar) playerView.findViewById(R.id.player_progress);
