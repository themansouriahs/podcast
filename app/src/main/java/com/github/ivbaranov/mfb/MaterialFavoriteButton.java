...
public class MaterialFavoriteButton extends ImageView {
  ...
  private static final int FAVORITE_STAR_BLACK = R.drawable.ic_star_24px;
  private static final int FAVORITE_STAR_BORDER_BLACK = R.drawable.ic_star_border_24px;
  private static final int FAVORITE_STAR_WHITE = R.drawable.ic_star_white_24px;
  private static final int FAVORITE_STAR_BORDER_WHITE = R.drawable.ic_star_border_white_24px;
  private static final int FAVORITE_HEART_BLACK = R.drawable.ic_favorite_24dp;
  private static final int FAVORITE_HEART_BORDER_BLACK = R.drawable.ic_favorite_outline_24dp;
  private static final int FAVORITE_HEART_WHITE = R.drawable.ic_favorite_white_24px;
  private static final int FAVORITE_HEART_BORDER_WHITE = R.drawable.ic_favorite_border_white_24px;
