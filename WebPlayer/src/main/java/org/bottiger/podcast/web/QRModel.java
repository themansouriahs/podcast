...
public class QRModel {
    ...
    public static String getQRUrl(HttpSession argSession) {
        return "https://zxing.org/w/chart?cht=qr&chs=400x400&chld=L&choe=UTF-8&chl=" + getQRValue(argSession);
    }

    public static String getQRValue(HttpSession argSession) {
        return nextSessionId() + sSeparator + getSessionID(argSession);
    }
